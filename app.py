...
BRISCO stands for **B**reast M**RI** **S**egmentation S**CO**ring. It is a plug-and-play web application designed for radiologists to evaluate the quality of breast MRI lesion segmentations, whether manual or generated by AI.
