...
# UI: WELCOME PAGE
# ---------------------------
st.title("Welcome to BRISCO (Breast MRI Segmentation ScOring) ")

st.markdown("""
### BRISCO is a plug-and-play web application designed for radiologists to evaluate the quality of breast MRI lesion segmentations, whether manual or generated by AI.
